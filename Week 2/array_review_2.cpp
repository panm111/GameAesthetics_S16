...
int main() 
{
	...
	//your code here---------------------------
		...
		char secondChars[] = {'d','e','f'};


		//swap all array values here:
		char tempArray[] =  {'d','e','f'};
		secondChars[0] = firstChars[0];
		secondChars[1] = firstChars[1];
		secondChars[2] = firstChars[2];
		firstChars[0] = tempArray[0];
		firstChars[1] = tempArray[1];
		firstChars[2] = tempArray[2];

		cout << "value of secondChars[0]: " << secondChars[0] << endl;
		cout << "value of secondChars[1]: " << secondChars[1] << endl;
		cout <<"value of secondChars[2]: " << secondChars[2] << endl;

		cout << "value of firstChars[0]: " << firstChars[0] << endl;
		cout << "value of firstChars[1]: " << firstChars[1] << endl;
		cout << "value of firstChars[2]: " <<firstChars[2] << endl;
